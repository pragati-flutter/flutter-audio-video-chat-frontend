...
class FirebaseMessagingHandler {
  ...
  static AndroidNotificationChannel channel_call =
    ...
    enableLights: true,
    playSound: true,
    sound: RawResourceAndroidNotificationSound('caller_tune'),
  );
...
/*  static Future<void> _showNotification({RemoteMessage? message}) async {
  ...
  static Future<void> CallVoiceVideoOrText(
      {RemoteMessage? initialMessageIos}) async {
    ...
    if (initialMessage != null) {
      print(
          "...got terminated notification android -> ${initialMessage.data}");
      _receiveNotification(initialMessage);
    }

    /// when app is in background
    FirebaseMessaging.onMessageOpenedApp.listen((message) {
      print("...got background notification -> ${message.data}");
      if (!Get.isSnackbarOpen &&
          !AppPages.history.contains(AppRoutes.VideoCall)) {
        _receiveNotification(message);
      }
    });
  }
